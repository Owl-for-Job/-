...
class GenreFeatureData:
    ...
    dir_trainfolder = "E:\\DataSet\\智能信息处理\\au_data\\_train"
    dir_devfolder = "E:\\DataSet\\智能信息处理\\au_data\\_validation"
    dir_testfolder = "E:\\DataSet\\智能信息处理\\au_data\\_test"
    dir_all_files = "E:\\DataSet\\智能信息处理\\au_data"

    train_X_preprocessed_data = "E:\\DataSet\\智能信息处理\\au_data\\data_train_input.npy"
    train_Y_preprocessed_data = "E:\\DataSet\\智能信息处理\\au_data\\data_train_target.npy"
    dev_X_preprocessed_data = "E:\\DataSet\\智能信息处理\\au_data\\data_validation_input.npy"
    dev_Y_preprocessed_data = "E:\\DataSet\\智能信息处理\\au_data\\data_validation_target.npy"
    test_X_preprocessed_data = "E:\\DataSet\\智能信息处理\\au_data\\data_test_input.npy"
    test_Y_preprocessed_data = "E:\\DataSet\\智能信息处理\\au_data\\data_test_target.npy"
    ...
    def extract_audio_features(self, list_of_audiofiles):
        ...
        for i, file in enumerate(list_of_audiofiles):
            ...
            genre_path = os.path.dirname(file)
    ...
    def path_to_audiofiles(dir_folder):
        ...
        list_of_audio = []
        for genres in os.listdir(dir_folder):
            files = os.path.join(dir_folder,genres)
            for file in os.listdir(files):
                #print(file)
                if file.endswith(".wav"):
                    directory = "%s\%s" % (os.path.join(dir_folder,genres), file)
                    #print(directory)
