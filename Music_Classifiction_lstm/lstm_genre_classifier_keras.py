...
model = Sequential()
model.add(LSTM(units=128, dropout=0, recurrent_dropout=0, return_sequences=True, input_shape=input_shape))
model.add(LSTM(units=32,  dropout=0, recurrent_dropout=0, return_sequences=False))
...
history=model.fit(
    ...
    epochs=num_epochs,
    validation_data=(genre_features.test_X,genre_features.test_Y)
)
...
# 保存图像到文件
plt.savefig('D:\\smartimfor\\智能信息处理\\智能信息处理\\Myclassification\\Data\\output\\training_history_LSTM.png')
plt.show()


# Creates a HDF5 file 'lstm_genre_classifier.h5'

model.save("D:\smartimfor\智能信息处理\智能信息处理\Myclassification\Data\model/LSTM.h5")
# Creates a json file
print("creating .json file....")
model_json = model.to_json()
f = Path("D:\smartimfor\智能信息处理\智能信息处理\Myclassification\Data\model/lstm_genre_classifier_lstm.json")
